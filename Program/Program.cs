...
namespace Program
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Pac man initial speed: " + vector.Length());

            //Vector2 doubled = vector.Increase(2);
            //Console.WriteLine("Pac man doubled speed: " + doubled.Length());

            //Vector2 halved = vector.Reduce(2);
            //Console.WriteLine("Pac man halved speed: " + halved.Length());
            ...
            //Console.WriteLine("Pac man view vector: " + normalized.x + ", " + normalized.y);
            //Console.WriteLine("Pac man view vector length: " + normalized.Length());

            //----------------------------------------------------------------------------------

            Vector2 vector = new Vector2(4, 0);
            Vector2 vector2 = new Vector2(0, -5);

            Vector2 vectorV = vector.AddVector(ref vector2);

            Console.WriteLine("Pac man new velocity: " + vectorV.x + ", " + vectorV.y);
